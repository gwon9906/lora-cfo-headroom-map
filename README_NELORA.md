...
>
> SF7 / BW125k, 10% SER, **그들 조건 그대로 · 같은 배치**(§5-4):
> `decode_loraphy` −13.11 dB → 그들 신경망 −14.49 dB(**+1.39**) →
> 학습도 정렬도 없는 표준 수신기 **−16.57 dB(+3.46)**.
> **표준 수신기가 신경망을 +2.08 dB**(그들 macro 평균으로는 +2.24 dB) **앞선다.**
>
