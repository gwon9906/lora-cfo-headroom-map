...
print("        %d trials/cell.  headroom = genie - blind" % T)
hdr=f"{'SNR':>5} |{'blind MF':>10}{'joint sym':>11}{'pkt ns=8':>10}{'pkt ns=32':>11}{'pkt ns=128':>12}{'genie':>9} |{'headroom':>10}"
...
for snr in SNRS:
    ...
    print(f"{snr:>5} |{ab:>9.1f}%{aj:>10.1f}%{p8:>9.1f}%{p32:>10.1f}%{p128:>11.1f}%{ag:>8.1f}% |{ag-ab:>9.1f}%p")
